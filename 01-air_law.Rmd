...
```{r, echo=FALSE, out.width="70%", fig.cap="Direct holding entry.", fig.align='center'}
knitr::include_graphics("img/holding_direct.jpg")
```

```{r, echo=FALSE, out.width="70%", fig.cap="Teardrop holding entry.", fig.align='center'}
knitr::include_graphics("img/holding_teardrop.jpg")
```

```{r, echo=FALSE, out.width="70%", fig.cap="Parallel holding entry.", fig.align='center'}
knitr::include_graphics("img/holding_parallel.jpg")
```
